...
class _WelcomeScreenState extends State<WelcomeScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    for (int i = 0; i < 8; i++) { // Reduced number of floating icons
      _floatingIcons.add({
        'icon': i % 3 == 0
            ? Icons.recycling
              ...
              return Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    stops: [
                      0.0,
                      0.4 + 0.15 * math.sin(_backgroundAnimation.value * 2 * math.pi),
                      1.0,
                    ],
                  ),
                ),
          ...
          ...List.generate(_floatingIcons.length, (index) {
            return AnimatedBuilder(
              ...
              builder: (context, child) {
                ...
                final y = (icon['y'] + _controller.value * icon['speed'] * 1.5) % 1.0;
      ...
      children: [
        TweenAnimationBuilder(
          ...
          builder: (context, double progress, child) {
            ...
            int displayValue = (progress * int.parse(value.replaceAll("+", ""))).toInt();
            return Text(
