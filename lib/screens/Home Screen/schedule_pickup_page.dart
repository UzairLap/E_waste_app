  ...
  Future<void> getCurrentLocation() async {
    ...
    try {
      ...
      if (placemarks.isNotEmpty) {
        ...
        setState(() {
          userAddress = "${place.street}, ${place.subLocality}, ${place.locality}, ${place.postalCode}, ${place.country}";
        });
      } else {
        setState(() {
  ...
  bool validateCurrentStep() {
    switch (_currentStep) {
      ...
      case 2: // Address and pictures
        return userAddress != null && userAddress!.isNotEmpty;
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => ReceiptPage(
              ...
              timeSincePurchased: timeSincePurchased!,
              address: userAddress!,
